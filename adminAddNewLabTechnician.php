...
if (isset($_POST['submit'])) {
  ...
  if (empty($technicianName) || empty($technicianId) || empty($dob) || empty($gender) || empty($address) || empty($email)  || empty($qualification) || empty($universityCollegeCountry)) {
  ...
  if (count($errors) == 0) {
    ...
    VALUES ('$technicianName', '$email',NULL, NULL,'$technicianId', '$qualification',NULL, '$universityCollegeCountry', 'Lab Technician')";
