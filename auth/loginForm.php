...
<body>
    <div id="loginForm">
        <form action="index.php" method="POST">
            ...
            <img id="closeLogin" src="assets/img/closeButton.png" alt="" />
        </form>
    </div>
</body>
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($row['isVerified'] == 1) {
            if ($password === $passwordHash) {
                ...
                <script>
                    ...
                    window.location.href = "dashboards/patient/patient.php";
                </script>
                <?php
            ...
            if ($password === $passwordHash) {
                ...
                ?>
                    <script>
                        ...
                        window.location.href = "dashboards/doctor/doctor.php";
                    </script>
                <?php
            ...
            if ($password === $passwordHash) {
                ...
                ?>
                        <script>
                            ...
                            window.location.href = "dashboards/lab/labTechnician.php";
                        </script>
                <?php
        ...
        if ($password === $passwordHash) {
            if ($row['isVerified'] == 1) {
                ...
                ?>
                            <script>
                                // Redirect to patient.php on successful login
                                window.location = "dashboards/receptionist/receptionist.php";
                            </script>
                <?php
        ...
        if ($password === $passwordHash) {
            ...
            ?>
                            <script>
                                // Redirect to doctor.php on successful login
                                window.location.href = "dashboards/admin/admin.php";
                            </script>
            <?php
