...
if (isset($_SESSION['technicianEmail'])) {
    ...
    $sqlCheckEmail = "SELECT COUNT(*) as count FROM images WHERE user_email = '$technicianEmail' AND image_data IS NOT NULL AND image_data != ''";
    ...
    if ($resultCheckEmail && $resultCheckEmail->num_rows > 0) {
        ...
        if ($count > 0) {
            ...
            $sql = "SELECT image_data FROM images WHERE user_email ='$technicianEmail'"; // Assuming you have an 'images' table with 'image_data' column
            ...
            if ($result && $result->num_rows > 0) {
                ...
                displayTechnicianDefaultAvatar($mysqli, $technicianEmail);
            }
        } else {
...
function displayTechnicianDefaultAvatar($mysqli, $technicianEmail)
{
    // Retrieve the gender from the patient table
    $sqlTechnician = "SELECT gender FROM lab_technician WHERE technicianEmail = '$technicianEmail'";
