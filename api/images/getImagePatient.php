...
if (isset($_SESSION['patientEmail'])) {
    ...
    $sqlCheckEmail = "SELECT COUNT(*) as count FROM images WHERE user_email = '$patientEmail' AND image_data IS NOT NULL AND image_data != ''";
    ...
    if ($resultCheckEmail && $resultCheckEmail->num_rows > 0) {
        ...
        if ($count > 0) {
            ...
            $sql = "SELECT image_data FROM images WHERE user_email ='$patientEmail'"; // Assuming you have an 'images' table with 'image_data' column
            ...
            if ($result && $result->num_rows > 0) {
                ...
                displayPatientDefaultAvatar($mysqli, $patientEmail);
            }
        } else {
