...
if (isset($_SESSION['receptionistEmail'])) {
    ...
    $sqlCheckEmail = "SELECT COUNT(*) as count FROM images WHERE user_email = '$receptionistEmail' AND image_data IS NOT NULL AND image_data != ''";
    ...
    if ($resultCheckEmail && $resultCheckEmail->num_rows > 0) {
        ...
        if ($count > 0) {
            ...
            $sql = "SELECT image_data FROM images WHERE user_email ='$receptionistEmail'"; // Assuming you have an 'images' table with 'image_data' column
            ...
            if ($result && $result->num_rows > 0) {
                ...
                displayReceptionistDefaultAvatar($mysqli, $receptionistEmail);
            }
        } else {
...
function displayReceptionistDefaultAvatar($mysqli, $receptionistEmail)
{
    // Retrieve the gender from the patient table
    $sqlTechnician = "SELECT gender FROM receptionist WHERE receptionistEmail = '$receptionistEmail'";
